...
export function TechStack() {
  return (
    <section id="tech-stack" className="py-20 bg-gradient-to-br from-sky-50 via-blue-50 to-cyan-50 dark:from-slate-900 dark:via-blue-950/10 dark:to-cyan-950/10">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-5xl md:text-6xl font-bold mb-4 text-slate-900 dark:text-slate-100">Tech Stack</h2>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg text-slate-900 dark:text-slate-100">{category.title}</h3>
                </div>
